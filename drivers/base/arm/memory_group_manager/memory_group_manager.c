...
static const struct acpi_device_id memory_group_manager_acpi_ids[] = {
	{ .id = "CIXHA013", .driver_data = 0 },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(acpi, memory_group_manager_acpi_ids);
...
static struct platform_driver
	memory_group_manager_driver = { .probe = memory_group_manager_probe,
					...
					.driver = {
						...
						.acpi_match_table = ACPI_PTR(memory_group_manager_acpi_ids),
						/*
